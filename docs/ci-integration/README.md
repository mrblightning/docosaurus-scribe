...
Scribe allows you to integrate our *SBOM* creation tool directly into your pipeline so that they may be viewed and shared directly from Scribe Hub. Below are two suggested integrations, using <a href='/docosaurus-scribe/docs/ci-integration/github-actions'>GitHub actions</a> and <a href='/docosaurus-scribe/docs/ci-integration/jenkins'>Jenkins over Kubernetes</a>. We also offer a more generalized option allowing integration with other <a href='/docosaurus-scribe/docs/ci-integration/general'>CI systems</a>.  
